    ...
    return (
        <Scroll html>
            ...
            <div className="h-screen w-full flex flex-col items-center justify-center relative pointer-events-none" style={{ opacity: opacityHero }}>
                <div className="relative z-10 text-center mix-blend-normal"> {/* Removed mix-blend-difference */}
                    <h1 className="text-[14vw] font-serif font-light leading-[0.85] tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white via-white/80 to-white/40 drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]">
                        Silence is<br/>
                        <span className="italic text-white/50">Frequency</span>
                    </h1>
                    <div className="flex justify-center mt-12">
                        {/* Bioluminescent Line */}
                        <div className="w-px h-32 bg-cyan-400 shadow-[0_0_10px_#22d3ee,0_0_20px_#22d3ee] animate-pulse" />
                    </div>
                </div>
            </div>
    ...
    return (
        <div className="h-screen w-full bg-[#050403]">
            ...
            <div className="fixed top-8 left-8 z-50 text-white/20 font-mono text-xs mix-blend-difference pointer-events-none">
                V5: HIGH_FREQUENCY_MATERIALIZATION // WEBGL // REFINED
            </div>
